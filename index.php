...
<body onload="myFunction()">
  ...
  <div class="wrapper animate-bottom" id="content">
    <header>
      <section class="module parallax parallax-1" id="top-parallax" style="background: linear-gradient(to right, #D3D3D3, white);" >
        <div class="top-block">
          <div class="avatar">
          </div>
    ...
    <div class="featured-projects-wrapper">
      ...
      <header>
    <section class="module parallax parallax-1" id="projects" style="background-image: url('https://res.cloudinary.com/marcusschimizzi/image/upload/v1518625323/busy_x8juar.jpg')">
...
<!--       <p><img class="project-images" src="./images/frogger.jpg" /></p>
 -->      
            <div class="project-images" style="background: url('https://res.cloudinary.com/marcusschimizzi/image/upload/v1504125705/frogger_be25kj.jpg') center;"></div>
            <div class="projects">
        <div class="titles">
...
<!--       <p><img class="project-images" src="http://res.cloudinary.com/marcusschimizzi/image/upload/v1504123162/871d0e5d3a57b37aa28a5b7cf867fcec_cirncl.png" /></p> -->      
          <div class="project-images" style="background: url('https://res.cloudinary.com/marcusschimizzi/image/upload/c_crop,g_xy_center,h_400,w_500,x_680,y_470/v1504123162/871d0e5d3a57b37aa28a5b7cf867fcec_cirncl.png') center;"></div>
          <div class="projects">
        <div class="titles">
...
<!--       <p><img class="project-images" src="./images/ge.jpg" /></p>
 -->      
          <div class="project-images" style="background: url('https://res.cloudinary.com/marcusschimizzi/image/upload/c_scale,w_608/c_crop,h_400,w_500/v1504125703/ge_t85ghe.jpg') center;"></div>  <div class="projects">
        <div class="titles">
...
<!--       <p><img class="project-images" src="./images/10.png" /></p>
 -->      
          <div class="project-images" style="background: url('https://res.cloudinary.com/marcusschimizzi/image/upload/c_scale,w_997/c_crop,g_xy_center,h_400,w_500,x_380/v1518625368/10_dvdlu8.png') center;"></div>
          <div class="projects">
        <div class="titles">
  ...
  <header>
    <section class="module parallax parallax-1"  id="resume" style="background-image: url('https://res.cloudinary.com/marcusschimizzi/image/upload/v1504125682/prog_vxcr4o.jpg')">
      <div class="title-container">
